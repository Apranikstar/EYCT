...
def get_process_from_sample(sample):
    ...
    import re
    match = re.search(r"wzp6_ee_(.+?)_ecm125", sample)
    if match:
...
def main():
    ...
    parser.add_argument("--sample", help="sample name", default="wzp6_ee_Hlnuqq_ecm125")
    ...
    "munumuqq": "munumuqq",
    "mumuqq": "mumuqq",
    "taunutauqq": "taunutauqq",
    "tautauqq": "tautauqq",
    "Htautau": "Htautau",  # THIS is the fix!
    "Hllnunu": "Hllnunu",
    "eenunu": "eenunu", 
    "mumununu": "mumununu",
    "tautaununu": "tautaununu", 
    "l1l2nunu": "l1l2nunu",
    "tautau": "tautau",  
    "Hgg": "Hgg",
    "Hbb": "Hbb",
    ...
    proc_name = flavor_to_process[process]  # I know it's redundant
